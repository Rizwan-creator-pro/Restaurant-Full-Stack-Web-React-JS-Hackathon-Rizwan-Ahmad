    ...
    return (
        <div className="w-full md:w-[870px] px-4 mx-auto my-8">
            <h2 className="text-2xl font-semibold my-4">
                Manage All <span className="text-green-600">Menu Items</span>
            </h2>
                        ...
                        <tbody>
                            {menu.map((item, index) => (
                                <tr key={index} className="hover:bg-gray-100">
                                    ...
                                    <td className="p-3">
                                        <button onClick={() => openEditModal(item)} className="p-2 rounded-md bg-green text-white">
                                            <FaEdit />
                                        </button>
                                    </td>
                                    <td className="p-3">
                    ...
                    <div className="bg-white rounded-lg p-6 w-96">
                        ...
                        <form onSubmit={handleSaveChanges}>
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button type="submit" className="p-2 bg-green text-white rounded-md">
                                    Save
                                </button>
                            </div>
                        </form>
